...
public final class SSLUtilities
{
	...
	/**
	 * Set the default Hostname Verifier to an instance of a fake class that trust all hostnames. This method uses the old
	...
	/**
	 * Set the default X509 Trust Manager to an instance of a fake class that trust all certificates, even the self-signed
	 * ones. This method uses the old deprecated API from the com.sun.ssl package.
	 * 
