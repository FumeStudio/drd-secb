...
//        NewsItem newsItem = new NewsItem();
    ...
    private void bindViews()
    {
        if(this.newsItem!=null){
            txtv_news_details_newTitle.setText(newsItem.newsItemTitle+" "+newsItem.newsItemTitle+" "+newsItem.newsItemTitle+" "+newsItem.newsItemTitle);
            txtv_news_details_newDate.setText(newsItem.newsItemDate);
            txtv_news_details_newBody.setText(newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription+newsItem.newsItemDescription);
